	...
	<nav class="navbar-default navbar-side" role="navigation">
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				<li>
					<a  class="active-menu"href="<?php echo site_url('test');?>"><i class="fa fa-dashboard"></i> รายการครุภัณฑ์</a>
				</li>
				<li>
	...
	<div id="page-wrapper">
		<div class="header">
			<h1 class="page-header">
				รายการครุภัณฑ์ <small></small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="<?php echo site_url('test/deviceList');?>">หน้าหลัก</a></li>
				<li class="active">เพิ่มรายการครุุภัณฑ์</li>
			</ol>
		</div>
		<div id="page-inner">
				<div class="row">
									...
									<div class="col-lg-9 col-sm-offset-1">
										...
										<form role="form" action="<?php echo site_url('test/show')?>" method="post">
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<input required class="form-control" type="text" name="id_std" placeholder="Enter text"  >
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<input required class="form-control" type="text" name="name_std" placeholder="Enter text" >
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<input required class="form-control" type="text" name="tell_std" placeholder="Enter text">
												</div>
